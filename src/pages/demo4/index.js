...
const Demo1 = () => {
    ...
    return (
        <div>
            ...
            <ul>
                <li>mousemove：Mouse Mobile Events</li>
                <li> mouseinteraction: mouse interaction incident </ li>
                <li> scroll: Rolling Frequency of Rolling Event </ li>
                <li> Input: Enter the recording timing of the event </ li>
            </ul>
